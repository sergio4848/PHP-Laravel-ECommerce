            ...
            <div class="col-sm-6 col-md-3">
                <div class="widget widget-brand">
                    <div class="logo logo-footer">
                        <a href="index.html"><img src="{{asset('assets')}}/images/logo@2x.png" alt="image" width="107" height="24"></a>
                    </div>
...
<script src="{{asset('assets')}}/javascript/tether.min.js"></script>
<script src="{{asset('assets')}}/javascript/bootstrap.min.js"></script>
<script src="{{asset('assets')}}/javascript/jquery.easing.js"></script>
<script src="{{asset('assets')}}/javascript/parallax.js"></script>
<script src="{{asset('assets')}}/javascript/jquery-waypoints.js"></script>
<script src="{{asset('assets')}}/javascript/jquery-countTo.js"></script>
<script src="{{asset('assets')}}/javascript/jquery.countdown.js"></script>
<script src="{{asset('assets')}}/javascript/jquery.flexslider-min.js"></script>
<script src="{{asset('assets')}}/javascript/images-loaded.js"></script>
<script src="{{asset('assets')}}/javascript/jquery.isotope.min.js"></script>
<script src="{{asset('assets')}}/javascript/magnific.popup.min.js"></script>
<script src="{{asset('assets')}}/javascript/jquery.hoverdir.js"></script>
...
<script src="{{asset('assets')}}/rev-slider/js/extensions/revolution.extension.actions.min.js"></script>
<script src="{{asset('assets')}}/rev-slider/js/extensions/revolution.extension.carousel.min.js"></script>
<script src="{{asset('assets')}}/rev-slider/js/extensions/revolution.extension.kenburn.min.js"></script>
<script src="{{asset('assets')}}/rev-slider/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script src="{{asset('assets')}}/rev-slider/js/extensions/revolution.extension.migration.min.js"></script>
<script src="{{asset('assets')}}/rev-slider/js/extensions/revolution.extension.navigation.min.js"></script>
