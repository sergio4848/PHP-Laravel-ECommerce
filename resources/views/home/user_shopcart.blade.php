...
@section ('content')
    ...
    <div class="container" style="padding-top: 100px;">
                ...
                <table id="customers">
                    ...
                    @foreach($datalist as $rs)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('user_shopcart_delete',['id'=>$rs->id])}}" onclick="return confirm('Delete ! Are you sure?')"><img src="{{asset('assets/admin/images')}}/delete.png" style="height: 30px;"></a>
                            </td>
                        </tr>
                        @php
        ...
        <div class="row">
            <div class="col-sm-12" style="padding-left: 700px;">
