...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-6" style="margin-left: auto;padding-top: 200px;">
            ...
            <div class="col-md-6" style="margin-right: auto;padding-top: 200px;">
                <br><br>
                ...
                <table>
                    ...
                    <tr><input style="width: 150px" id="dates" type="text"  name="dates" placeholder="Valid Dates mm/yy"/>
                        <input style="width: 150px" id="secret" type="password" name="key" placeholder="Secret Number"/></tr><br><br><br>
